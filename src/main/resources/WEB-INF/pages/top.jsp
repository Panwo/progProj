...
<a class="btn btn-primary" href="form.html" onclick="window.open(this.href, '', 'scrollbars=1'); return false;">Регистрация</a>
            ...
            <!----------------------------insert here ---------------------------------------->
              ...
              <c:forEach items="${products}" var = "products">
                  <div class="products-main">
                      <div class="product">
                          <h2><a href = "#">$<products.description></products.description></a></h2>
                          <div class="product-img"><a href = "#"><img src="111.jpg" width="320" height="240" align="middle" /></a> </div>
                          <p class="price">$<products.price></products.price><span> грн</span>
                      </div>
                      <p class="bot-dot"></p>
                  </div>
